...
server.router = {
	'/api/candidates/add': handlers.addCandidate,
	'/api/candidates/all': handlers.getAllCandidates,
	'/api/candidates/:id/': handlers.getCandidateById,
	'/api/candidates/:id/vote': handlers.voteCandidateById,
	'/api/candidates/:id/disqualify': handlers.disqualifyCandidate,
	'/api/candidates/:id/remove': handlers.deleteCandidate
}
